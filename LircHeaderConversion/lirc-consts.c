...
int main()
{
  ...
  printval("LIRC_CAN_SET_REC_DUTY_CYCLE", LIRC_CAN_SET_REC_DUTY_CYCLE);
  printval("LIRC_CAN_SET_REC_DUTY_CYCLE_RANGE", LIRC_CAN_SET_REC_DUTY_CYCLE_RANGE);
  ...
  printval("LIRC_CAN_SET_REC_FILTER", LIRC_CAN_SET_REC_FILTER);
  ...
  printval("LIRC_CAN_NOTIFY_DECODE", LIRC_CAN_NOTIFY_DECODE);
