...
{
    public class RC6Mode6A16RawBitsPacket : RC6Mode6A16Packet
    {
        public bool[] PayloadBits { get; set; }

        public RC6Mode6A16RawBitsPacket()
        {
        }

        public RC6Mode6A16RawBitsPacket(RC6Mode6A16Packet basicPacket, bool[] payloadBits) : base(basicPacket.Mode, basicPacket.Trailer, basicPacket.Address)
        {
            PayloadBits = payloadBits;
        }

        public RC6Mode6A16RawBitsPacket(ushort address, bool[] payloadBits) : base(address)
        {
            PayloadBits = payloadBits;
        }
